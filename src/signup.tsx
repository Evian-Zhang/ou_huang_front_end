...
class SignUp extends Component<SignUpProps, SignUpState> {
    ...
    encryptPassword(): string {
        const key = CryptoJs.enc.Hex.parse(this.props.skey);
        ...
        const p = CryptoJs.AES.decrypt(cipher, key, {
            iv: iv,
            mode: CryptoJs.mode.CTR,
            padding: CryptoJs.pad.NoPadding,
        });
    ...
    handleSubmit() {
        ...
        const data = {Sid: this.props.sid, Username: this.state.username, Password: this.encryptPassword()};
